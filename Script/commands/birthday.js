...
module.exports.run = async function ({ api, event, args }) {
 ...
 { delay: 14000, msg: `আজ জন্মদিনে আনন্দ ও সুন্দর মুহুর্তে ভরে উঠুক এই কামনাই করি ...শুভ জন্মদিন @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}` },
 ...
 { delay: 26000, msg: `শুভ হোক তোমার আগামী দিন।💖\nতোমার এই মুখের হাসি যেন সারাজীবন এমনি থাকুক, হ্যাপি বার্থডে☺️ @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}` },
 { delay: 30000, msg: `জন্মদিনের শুভেচ্ছা নিও প্রিয় @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}!🎂\nতোমার পথ চলা হোক আনন্দের, ভালোবাসার ও সাফল্যের।` },
 { delay: 34000, msg: `many many happy returns of the day 🥰😘\n Happy Birthday🎂 @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}` },
 { delay: 38000, msg: `মন থেকে দোয়া করি‌ সব‌ সময় সুখে থাকো ভালো থাকো 🥰 \nশুভ জন্মদিন @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}!` },
 { delay: 42000, msg: `সবশেষে একটাই প্রত্যাশা সবসময় পাশে আছি ইনশাল্লাহ পাশে পাব🥰😘 @${@ＭＡＨＩＲ▁▁▁🤗👿😘😈🫣👿😘👿😚😈}` }
 ];
